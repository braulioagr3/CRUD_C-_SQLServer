...
namespace CRUD_SQL_Server {
    ...
    public partial class PersonaDataSet : global::System.Data.DataSet {
        ...
        public partial class AlumnoDataTable : global::System.Data.TypedTableBase<AlumnoRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public AlumnoRow AddAlumnoRow(string nombre, string apellido, int edad) {
...
namespace CRUD_SQL_Server.PersonaDataSetTableAdapters {
    ...
    public partial class AlumnoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Alumno] WHERE (([idAlumno] = @Original_idAlumno) AND ([nombre]" +
                " = @Original_nombre) AND ([apellido] = @Original_apellido) AND ([edad] = @Origin" +
                "al_edad))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Alumno] ([nombre], [apellido], [edad]) VALUES (@nombre, @apell" +
                "ido, @edad);\r\nSELECT idAlumno, nombre, apellido, edad FROM Alumno WHERE (idAlumn" +
                "o = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Alumno] SET [nombre] = @nombre, [apellido] = @apellido, [edad] = @edad WHERE (([idAlumno] = @Original_idAlumno) AND ([nombre] = @Original_nombre) AND ([apellido] = @Original_apellido) AND ([edad] = @Original_edad));
SELECT idAlumno, nombre, apellido, edad FROM Alumno WHERE (idAlumno = @idAlumno)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CRUD_SQL_Server.Properties.Settings.Default.PersonaConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT idAlumno, nombre, apellido, edad FROM dbo.Alumno";
        ...
        public virtual int Fill(PersonaDataSet.AlumnoDataTable dataTable) {
        ...
        public virtual PersonaDataSet.AlumnoDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            PersonaDataSet.AlumnoDataTable dataTable = new PersonaDataSet.AlumnoDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(PersonaDataSet.AlumnoDataTable dataTable) {
        ...
        public virtual int Delete(int Original_idAlumno, string Original_nombre, string Original_apellido, int Original_edad) {
        ...
        public virtual int Insert(string nombre, string apellido, int edad) {
            if ((nombre == null)) {
        ...
        public virtual int Update(string nombre, string apellido, int edad, int Original_idAlumno, string Original_nombre, string Original_apellido, int Original_edad, int idAlumno) {
            if ((nombre == null)) {
                throw new global::System.ArgumentNullException("nombre");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[6].Value = ((int)(Original_edad));
            this.Adapter.UpdateCommand.Parameters[7].Value = ((int)(idAlumno));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string nombre, string apellido, int edad, int Original_idAlumno, string Original_nombre, string Original_apellido, int Original_edad) {
            return this.Update(nombre, apellido, edad, Original_idAlumno, Original_nombre, Original_apellido, Original_edad, Original_idAlumno);
        }
    }
